...
def login_page():
    ...
    if not st.session_state.authenticated:
        ...
        with st.form("login_form"):
            ...
            if login:
                if user == "simulasiSAT" and pw == "SAT234":
                   ...
                   # Logika untuk mencari Top Destination (FIXED)
                    ...
                    with col_pie1:
                        ...
                        if total > 0:
                            ...
                            st.plotly_chart(fig_overall, use_container_width=True, key=f"switch_overall_{i}")
                    ...
                    with col_pie2:
                        ...
                        if not df_only_sw.empty:
                            ...
                            st.plotly_chart(fig_dest_pie, use_container_width=True, key=f"switch_destination_{i}")
                    ...
                    if not df_promo.empty:
                        ...
                        st.plotly_chart(fig_promo, use_container_width=True, key=f"switch_promo_{i}")
                    else:
